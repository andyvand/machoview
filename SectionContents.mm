                        ...
                        length:(uint32_t)length
{
  ...
  while (NSMaxRange(range) < location + length)
  {
    ...
    NSString * symbolName = [NSString stringWithFormat:@"%@->%@",
                             [self findSymbolAtRVA:[self fileOffsetToRVA:(uint32_t)range.location]],
    ...
    symbolNames[@([self fileOffsetToRVA:(uint32_t)range.location])] = symbolName;
  }
                          ...
                          length:(uint32_t)length
{
  ...
  while (NSMaxRange(range) < location + length)
  {
    ...
    NSString * symbolName = [NSString stringWithFormat:@"%@->%@",
                             [self findSymbolAtRVA64:[self fileOffsetToRVA64:(uint32_t)range.location]],
    ...
    symbolNames[@([self fileOffsetToRVA64:(uint32_t)range.location])] = symbolName;
  }
                       ...
                       length:(uint32_t)length
{
  ...
  while (NSMaxRange(range) < location + length)
  {
    ...
    if ([self is64bit] == NO)
    {
      uint32_t rva = [self fileOffsetToRVA:(uint32_t)range.location];
      symbolNames[@(rva)] = [NSString stringWithFormat:@"0x%X:\"%@\"", rva, symbolName];
    }
    else
    {
      uint64_t rva64 = [self fileOffsetToRVA64:(uint32_t)range.location];
                           ...
                           length:(uint32_t)length
{
  ...
  while (NSMaxRange(range) < location + length)
  {
    ...
    NSString * symbolName = [self findSymbolAtRVA:[self fileOffsetToRVA:(uint32_t)range.location]];
    [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location]
                           :lastReadHex
                           :@"Indirect Pointer"
                           :symbolName];
                             ...
                             length:(uint32_t)length
{
  ...
  while (NSMaxRange(range) < location + length)
  {
    ...
    NSString * symbolName = [self findSymbolAtRVA64:[self fileOffsetToRVA64:(uint32_t)range.location]];
    [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location]
                           :lastReadHex
                           :@"Indirect Pointer"
                           :symbolName];
...
//============================= X86 =========================
//===========================================================
static AsmFootPrint const __unused classicStubHelperX86 =
{
    {1, 0x68}, GAP(4),                        // pushl   $foo$lazy_ptr
    {1, 0xE9}, GAP(4),                        // jmp     helperhelper
};

static AsmFootPrint const __unused hybridStubHelperX86 =
{
...
static AsmFootPrint const __unused fastStubHelperX86 =
{
  {1, 0x68}, GAP(4),                        // pushl   $lazy-info-offset
  {1, 0xE9}, GAP(4),                        // jmp     helperhelper
};
...
static AsmFootPrint const __unused classicStubHelperX86_64 =
{
...
static AsmFootPrint const __unused hybridStubHelperX86_64 =
{
...
static AsmFootPrint const __unused hybridStubHelperHelperX86_64 =
{
...
static AsmFootPrint const __unused fastStubHelperX86_64 =
{
  {1, 0x68}, GAP(4),                        // pushq  $lazy-info-offset
    {1, 0xE9}, GAP(4),                        // jmp    helperhelper
};

static AsmFootPrint const __unused fastStubHelperHelperX86_64 =
{
...
//=========================== ARM ===========================
//===========================================================
static AsmFootPrint const __unused fastStubHelperARM =
{
...
static AsmFootPrint const __unused fastStubHelperHelperARM =
{
                          ...
                          length:(uint32_t)length
{
  ...
  if ([self matchAsmAtOffset:(uint32_t)range.location
                   ...
                   lineCount:sizeof(hybridStubHelperHelperX86)/FOOTPRINT_STRIDE])
  {
    ...
    address = [self fileOffsetToRVA:(uint32_t)NSMaxRange(range) + *(uint32_t *)((uint8_t *)data.bytes + 1)];
    [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location]
                           :lastReadHex
  ...
  else if ([self matchAsmAtOffset:(uint32_t)range.location
