                           ...
                           length:(uint32_t)length
{
  ...
  while (NSMaxRange(range) < location + length)
  {
    MATCH_STRUCT(objc_module_t,(uint32_t)NSMaxRange(range))
                            ...
                            length:(uint32_t)length
{
  ...
  while (NSMaxRange(range) < location + length)
  {
    MATCH_STRUCT(message_ref,(uint32_t)NSMaxRange(range))
                              ...
                              length:(uint32_t)length
{
  ...
  while (NSMaxRange(range) < location + length)
  {
    MATCH_STRUCT(message_ref64,(uint32_t)NSMaxRange(range))
...
{  
  ...
  {
    MATCH_STRUCT(method_t,(uint32_t)NSMaxRange(range))
...
{  
  ...
  {
    MATCH_STRUCT(method64_t,(uint32_t)NSMaxRange(range))
...
{  
  ...
  {
    MATCH_STRUCT(objc_property,(uint32_t)NSMaxRange(range))
...
{  
  ...
  {
    MATCH_STRUCT(objc_property64,(uint32_t)NSMaxRange(range))
...
{  
  ...
  node = [parent insertChildWithDetails:[@"ObjC2 Protocol64 List: " stringByAppendingString:caption]
                               location:location 
                                 length:(uint32_t)(sizeof(struct protocol64_list_t) + protocol64_list_t->count*sizeof(uint64_t))
                                  saver:nodeSaver];
...
{  
  ...
  {
    MATCH_STRUCT(ivar_t,(uint32_t)NSMaxRange(range))
...
{  
  ...
  {
    MATCH_STRUCT(ivar64_t,(uint32_t)NSMaxRange(range))
